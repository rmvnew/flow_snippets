...
--------------------------------------------------------------
    ...
    { -328.52,-136.76,39.01,446,2,"LS",0.8 }, --Mecanica LS
    { 67.34,-1754.01,48.04,446,2,"STO MOTORS",0.8 }, --Mecanica Sul
...
--------------------------------------------------------------
    ...
    { 2518.29,4103.02,38.59,140,59,"MOTOCLUBE",0.5 }, 
...
--------------------------------------------------------------
    ...
    {-47.52,-1756.85,29.42,52,0, "Loja de departamento", 0.5},
    {-1223.38,-907.15,12.32,52,0, "Loja de departamento", 0.5},
    {25.74,-1345.26,29.49,52,0, "Loja de departamento", 0.5},
    {1135.70,-981.79,46.41,52,0, "Loja de departamento", 0.5},
    {1163.53,-323.54,69.20,52,0, "Loja de departamento", 0.5},
    {374.19,327.50,103.56,52,0, "Loja de departamento", 0.5},
    {2555.35,382.16,108.62,52,0, "Loja de departamento", 0.5},
    {2676.76,3281.57,55.24,52,0, "Loja de departamento", 0.5},
    {1960.50,3741.84,32.34,52,0, "Loja de departamento", 0.5},
    {1393.23,3605.17,34.98,52,0, "Loja de departamento", 0.5},
    {1166.08,2709.24,38.15,52,0, "Loja de departamento", 0.5},
    {547.98,2669.75,42.15,52,0, "Loja de departamento", 0.5},
    { 1698.30,4924.37,42.06,52,0, "Loja de departamento", 0.5},
    {1729.54,6415.76,35.03,52,0, "Loja de departamento", 0.5},
    {-3243.90,1001.40,12.83,52,0, "Loja de departamento", 0.5},
    {-2968.00,390.80,15.04,52,0, "Loja de departamento", 0.5},
    {-3041.17,585.16,7.90,52,0, "Loja de departamento", 0.5},
    {-1820.55,792.77,138.11,52,0, "Loja de departamento", 0.5},
    {-1486.87,-379.77,40.16,52,0, "Loja de departamento", 0.5},
    {-707.40,-913.68,19.21,52,0, "Loja de departamento", 0.5},

    {-412.78,1102.73,327.68},
    {-1067.01,-842.21,5.11},
    {-289.81,-725.65,125.23},
    {420.16,-1493.94,33.8},
    {1267.27,-1381.79,47.28},
    {1246.54,-1145.85,37.95},
    {-1760.47,-201.13,57.79},
    {3030.35,3008.64,91.58},
    {118.87,-1302.43,29.27},
    {-560.29,285.18,82.18},
    {932.19,42.65,81.08},
    {379.21,3551.74,34.86},
    {-1528.15,842.96,181.59},
    {-170.42,294.93,93.75},
    {-2361.33,1749.95,212.12},
    {-215.28,-330.21,30.06},
    {1847.71,421.96,166.7},
    {-1988.3,-500.58,16.45},
    {-412.11,878.68,235.14},
    {372.78,-2055.03,21.74},
    {414.93,8.8,91.93},
    {1002.39,-128.46,74.05},
    {726.74,-324.6,53.23},
    {-891.82,-1469.48,7.53},
    {-63.05,834.32,231.33},
    {874.44,1033.77,280.73},
    {80.55,-1902.81,21.69},
    {-3206.03,792.0,8.93},
    {-948.31,-2065.81,9.4},
    {-1433.98,207.34,57.81},
    {1415.12,1165.1,114.33},
    
    
    {-1388.42,-615.01,30.31},
    {-1595.76,-61.52,56.48},
...
config.doors = {
        ...
        -- [214] = { coords = vec3(462.18,-1002.23,24.9), distance = 2.0, text = { true }, trancado = { true }, hash = { 631614199 }, perm = { "perm.policia" }, },
        -- [215] = { coords = vec3(462.28,-998.5,24.9), distance = 2.0, text = { true }, trancado = { true }, hash = { 631614199 }, perm = { "perm.policia" }, },
        -- [216] = { coords = vec3(462.24,-993.46,24.9), distance = 2.0, text = { true }, trancado = { true }, hash = { 631614199 }, perm = { "perm.policia" }, },
...
config.elevador = {
    ...
    ["Bahamas"] = {
        name = "Bahamas",
        andares = {
            ["H"] = {-1390.74,-681.69,39.11},
            ["T"] = {-1399.47,-657.78,28.68 }
        }
    },
    ["Militar"] = {
        name = "Militar",
        andares = {
            ["H"] = {463.57,-986.79,43.69},
...
config.locationElevador = {
    ...
    { type = "Bahamas", coords = vec3(-1390.74,-681.69,39.11), andar = "H" },
    { type = "Bahamas", coords = vec3(-1399.47,-657.78,28.68 ), andar = "T" },
